...
/**
 * ADCoefStressDivergenceTensors is the automatic differentiation version of StressDivergenceTensors
 */
class ADCoefStressDivergenceTensors : public ADKernel
{
public:
  static InputParameters validParams();

  ADCoefStressDivergenceTensors(const InputParameters & parameters);
